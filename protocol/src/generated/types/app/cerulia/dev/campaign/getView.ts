...
import type * as AppCeruliaDevCoreCampaign from '../core/campaign.js'
import type * as AppCeruliaDevCoreRuleProfile from '../core/ruleProfile.js'

const is$typed = _is$typed,
  validate = _validate
const id = 'app.cerulia.dev.campaign.getView'
