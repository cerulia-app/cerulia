...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.cerulia.dev.core.characterAdvancement'

export interface Main {
  $type: 'app.cerulia.dev.core.characterAdvancement'
...
export interface DeltaPayload {
  $type?: 'app.cerulia.dev.core.characterAdvancement#deltaPayload'
}
...
export interface PreviousValues {
  $type?: 'app.cerulia.dev.core.characterAdvancement#previousValues'
}
