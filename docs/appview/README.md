...
| target MVP | この README、`service-vision.md`、`features.md`、`layer-boundaries.md`、`navigation.md` の target section、`ui-ux-requirements.md` の target section、`test-plan.md` の target section | 再実装で目指す surface と境界 |
