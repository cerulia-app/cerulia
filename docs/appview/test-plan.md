...
AppView は system console ではなく service layer なので、この計画は次を証明することを目的にする。
...
| ID | level | 対象 | 主要検証点 |
| --- | --- | --- | --- |
| D-1 | visual/integration | public top composition | hero stage、value lane、featured publications、final sign-in CTA が存在すること |
