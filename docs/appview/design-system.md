...
- shared primitive は surface card、button link、status chip、archive notice など、route をまたいで意味が安定しているものに限る
...
- status、archive state、reader lens の違いは text と copy で判別できること
