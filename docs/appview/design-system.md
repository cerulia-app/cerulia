...
### 1. public profile ではなく character detail である

Cerulia の canonical shared surface は character detail であり、プレイヤー単位の public profile ではない。
画面が「誰のアカウントか」よりも「どのキャラクターか」を主語にしていることを優先する。
