...
ここでは「他の人に見せる」体験を完成させる。public shared surface の root は character detail とする。standalone な public session 個別 route は置かない。player profile は character detail に次ぐ共有面として扱う。プレイヤー単位の public character collection は secondary surface とし、post-MVP に回す。
