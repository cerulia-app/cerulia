...
Cerulia が最初に強く助けたいのは、CoC に限らず複数システムのシナリオを遊び、多くの PC を持ち、卓ごとに別サービスへキャラクターが散っている PL である。

このユーザーは、自分の慣れたサービスで GM に共有すると相手を困らせやすく、逆に卓ごとに相手の都合に合わせると自分の記録が分散する。Cerulia はこのねじれを、「どのシステムでも作れる」「遊んだ履歴が残る」「同じリンクで共有できる」で解く。

## 最初に成立させたい体験

Cerulia が最初に end-to-end で成立させるべき体験は次の 1 本である。

1. 他人から共有されたキャラクター詳細を見て便利そうだと感じる
2. アカウントを紐づけて自分のキャラクターを作る
...
Cerulia が成立したと言えるのは、PL 同士が Cerulia のキャラクターリンクを自然にやり取りし、Bluesky 上のキャラクター共有が活発になり、AT Protocol 上に周辺の reader や連携クライアントが立ち始める状態である。
